# Peatio Charts CI Documentation
...
- `build-master`
    ...
    - configure peatio-charts-repository `uri` to change ssh link to your respository.
    - configure peatio-charts-repository `branch` to change building branch of your respository.
